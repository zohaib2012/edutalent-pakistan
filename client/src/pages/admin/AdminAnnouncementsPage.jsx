...
export default function AdminAnnouncementsPage() {
  ...
  const handleSave = async () => {
    ...
    const payload = {
      ...
      targetPhase: form.targetPhase || null,
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {loading ? (
                    ...
                    <tr><td colSpan={7} className="text-center py-10 text-gray-400">No announcements found.</td></tr>
                  ) : filtered.map((a, i) => (
              ...
              <div className="bg-white rounded-xl w-full max-w-2xl mx-4 shadow-2xl">
                ...
                <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
                  ...
                  <div>
                    ...
                    <input type="text" value={form.summary} onChange={(e) => setForm({ ...form, summary: e.target.value })} placeholder="Brief summary shown on cards" className={inputClass} />
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <select value={form.targetPhase} onChange={(e) => setForm({ ...form, targetPhase: e.target.value })} className={inputClass}>
